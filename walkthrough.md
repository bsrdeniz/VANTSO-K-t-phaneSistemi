...
6. **Rol Bazlı Yetkilendirme (Simülasyon):** Sol menünün en altında yer alan select kutusu üzerinden aktif kullanıcıyı değiştirerek **Yönetici**, **Kütüphane Görevlisi** veya **Standart Personel** yetkilerini simüle edebilirsiniz. Ekranlar ve menüler, seçilen role göre otomatik olarak kısıtlanır veya açılır.
